...
bool master_thread::handle_cmdu_1905_associated_sta_link_metrics_response(const std::string &src_mac,
                                                          ieee1905_1::CmduMessageRx &cmdu_rx)
{
    auto mid = cmdu_rx.getMessageId();
    LOG(INFO) << "Received ASSOCIATED_STA_LINK_METRICS_RESPONSE_MESSAGE, mid=" << std::dec << int(mid);
