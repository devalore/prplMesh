...
class test_flows:
    ...
    def test_channel_selection(self):
        ...
        self.gateway_ucc.dev_send_1905(self.mac_repeater1, 0x8006, \
          (0x8B,0x005F,"{%s %s}" % (self.mac_repeater1_wlan0,payload_wlan0)), \
          (0x8D,0x0007,"{%s %s}" % (self.mac_repeater1_wlan0,payload_empty)), \
          (0x8B,0x004C,"{%s %s}" % (self.mac_repeater1_wlan2,payload_wlan2)), \
          (0x8D,0x0007,"{%s %s}" % (self.mac_repeater1_wlan2,payload_empty)))
        time.sleep(1)
        ...
        self.check_log(self.gateway, "controller", "PERATING_CHANNEL_REPORT_MESSAGE")
